...
class AppStrings {
  static const Map<String, Map<String, String>> _localizedValues = {
    'hi': {
      ...
      'rahuKaal': 'राहुकाल',
      'rahuKaalCaution': 'इस अवधि में शुभ कार्य न करें',
      'upcomingFestivals': 'आगामी पर्व एवं त्यौहार',
      'sacredSeva': 'पवित्र सेवा',
      'supportOurCows': 'गौमाता सेवा सहयोग',
      'donateBtn': 'सहयोग करें',
      'donateDesc': 'गौशाला पोषण एवं सेवा में पुण्य योगदान दें',
      'videosAndSatsang': 'दिव्य सत्संग व कथा',
      'videosDesc': 'दैनिक लाइव आरती, कथा एवं विशेष प्रवचन',
      'amritVachanTitle': 'दैनिक अमृत विचार',
      // General & Common
      'hariPath': 'हरि पाठ',
    ...
    'en': {
      ...
      'rahuKaal': 'Rahu Kaal',
      'rahuKaalCaution': 'Avoid auspicious work during this time',
      'upcomingFestivals': 'Upcoming Festivals',
      'sacredSeva': 'Sacred Seva',
      'supportOurCows': 'Support Gaumata Seva',
      'donateBtn': 'Donate',
      'donateDesc': 'Contribute to sacred cow shelter and care',
      'videosAndSatsang': 'Divine Satsang & Katha',
      'videosDesc': 'Daily Live Aarti, Katha & Special Discourses',
      'amritVachanTitle': 'Daily Sacred Thought',
      // General & Common
      'hariPath': 'Hari Path',
    ...
    'mr': {
      ...
      'rahuKaal': 'राहुकाळ',
      'rahuKaalCaution': 'या काळात शुभ कार्य करू नका',
      'upcomingFestivals': 'आगामी सण व उत्सव',
      'sacredSeva': 'पवित्र सेवा',
      'supportOurCows': 'गोमाता सेवा सहकार्य',
      'donateBtn': 'दान करा',
      'donateDesc': 'गोशाळा पोषण आणि सेवेत योगदान द्या',
      'videosAndSatsang': 'दिव्य सत्संग व कथा',
      'videosDesc': 'दैनिक थेट आरती, कथा आणि प्रवचन',
      'amritVachanTitle': 'दैनिक अमृत विचार',
      // General & Common
      'hariPath': 'हरि पाठ',
    ...
    'gu': {
      ...
      'rahuKaal': 'રાહુકાળ',
      'rahuKaalCaution': 'આ સમય દરમિયાન શુભ કાર્ય ન કરવું',
      'upcomingFestivals': 'આગામી તહેવારો',
      'sacredSeva': 'પવિત્ર સેવા',
      'supportOurCows': 'ગૌમાતા સેવા સહયોગ',
      'donateBtn': 'દાન કરો',
      'donateDesc': 'ગૌશાળા પોષણ અને સેવામાં યોગદાન આપો',
      'videosAndSatsang': 'દિવ્ય સત્સંગ અને કથા',
      'videosDesc': 'દૈનિક લાઈવ આરતી, કથા અને પ્રવચન',
      'amritVachanTitle': 'દૈનિક અમૃત વિચાર',
      // General & Common
      'hariPath': 'હરિ પાઠ',
      'getStarted': 'શરૂ કરો',
      'next': 'આગળ',
    ...
    'ta': {
      ...
      'rahuKaal': 'ராகு காலம்',
      'rahuKaalCaution': 'இந்த நேரத்தில் சுப காரியங்களைத் தவிர்க்கவும்',
      'upcomingFestivals': 'வரவிருக்கும் விழாக்கள்',
      'sacredSeva': 'புனித சேவை',
      'supportOurCows': 'கோமாதா சேவை உதவி',
      'donateBtn': 'நன்கொடை',
      'donateDesc': 'கோசாலை பராமரிப்பு மற்றும் சேவையில் பங்களிக்கவும்',
      'videosAndSatsang': 'புனித சத்சங்கம் & கதை',
      'videosDesc': 'தினசரி நேரலை ஆரத்தி, கதை & உபன்யாசங்கள்',
      'amritVachanTitle': 'தினசரி அமுத சிந்தனை',
      // General & Common
      'hariPath': 'ஹரி பாதம்',
    ...
    'te': {
      ...
      'inauspiciousPeriod': 'అశుభ సమయం',
      'rahuKaal': 'రాహుకాలం',
      'rahuKaalCaution': 'ఈ సమయంలో శుభకార్యాలు చేయవద్దు',
      'upcomingFestivals': 'రాబోయే పండుగలు',
      'sacredSeva': 'పవిత్ర సేవ',
      'supportOurCows': 'గోమాత సేవ సహాయం',
      'donateBtn': 'విరాళం',
      'donateDesc': 'గోశాల పోషణ మరియు సేవలో భాగస్వామ్యం అవ్వండి',
      'videosAndSatsang': 'దివ్య సత్సంగం & కథ',
      'videosDesc': 'రోజువారీ లైవ్ హారతి, కథ & ప్రవచనాలు',
      'amritVachanTitle': 'రోజువారీ అమృత ఆలోచన',
      // General & Common
      'hariPath': 'హరి పాఠం',
